<div class="panel panel-default">
        <div class="panel-heading">
            <a class="panel-title" data-parent="#panel-resBusqueda" data-toggle="collapse" href="#panel-resApelaciones">
        ...
        <div id="panel-resApelaciones" class="panel-collapse collapse causaResult">
            <div class="row clearfix helpRow">
                <div class="col-md-12 column ui-sortable ">
                    <h3>Esta causa es del tipo: <strong> PR15- Protección-Protección </strong></h3>
                   ...
                   <div class="col-md-4 column ui-sortable">
                        <a id="modal-660944" href="#modal-container" 
                           ...
                           data-toggle="modal" data-url="components/guides/apelaciones/recursoProteccion.php"
                    ...
                    <div class="col-md-4 column ui-sortable">
                        <a id="modal-660944" href="#modal-container" 
                           role="button" class="btn helpBtn" 
                           data-toggle="modal" data-url="components/diagrams/rProteccion.php"
                           data-title="Diagrama Arrendamiento"><h4>Diagrama</h4></a>
                        
                    </div>
                    <div class="col-md-4 column ui-sortable">
                        <a href="http://www.leychile.cl/Navegar?idNorma=18" target="_blank"><h4>Leyes</h4></a>
                    </div>
                </div>
            </div>
            <br>
            <div class="row clearfix">
                <div class="col-md-12 column ui-sortable">
                    <ul>
                        <li><strong>Estado del Recurso:</strong>  Vigente</li>
                        <li><strong>Estado Procesal :</strong> Fallada-terminada</li>
                        <li><strong>Dirección</strong>
                            <a href="https://www.google.com/maps/place/Bandera+344/@-33.4392774,-70.6523833,17z/data=!3m1!4b1!4m2!3m1!1s0x9662c5a46c4fc997:0x58d5c7750a4a75c4" target="_blank">Corte de Apelaciones de Santiago (Calle Bandera Nº 344)</a>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <table class="table table-condensed">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>7446877-2</td>
                                                <td>NATURAL</td>
                                                <td>David Vilches Altamirano</td>
                                            </tr>
                                            <tr>
                                                <td>Recurrido</td>
                                                <td>0-0</td>
                                                <td>NATURAL</td>
                                                <td>Pedro Cisternas Flores</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="panel-collapse collapse in panel-historia" >
                                <div class="panel-body">
                                    <table class="table table-condensed">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>Cuenta Protección</td>
                                                <td>Sentencia</td>
                                                <td>Inadmisible</td>
                                                <td>10/03/2014</td>
                                                <td><a href="components/case/docs/sentApel.doc">descargar</a></td>
                                            </tr>
                                            <tr>
                                                <td>...</td>
                                                <td>Escrito</td>
                                                <td>Ingreso Recurso</td>
                                                <td>07/03/2014</td>
                                                <td><a target="_blank">Descargar</a></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
